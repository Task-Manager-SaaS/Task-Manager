      ...
      <div className='w-full md:w-auto flex gap-0 md:gap-40 flex-col md:flex-row items-center justify-'>
        ...
        <div className='w-full md:w-1/3 p-4 md:p-1 flex flex-col justify-center items-center'>
          <form onSubmit={handleSubmit(submitHandler)}
            className='form-container w-full md:w-[400px] f;ex flex-col gap-y-8 bg-white px-10 pt-14 pb-14'
          >
            <div className=''>
              <p className="text-purple-800 text-3xl font-bold text-center">
                Welcome back!
              </p>
              <span className="block mt-2 text-center text-base text-blue-500">
            ...
            <div className='flex flex-col gap-y-5'>
              ...
              <Button
                ...
                transition duration-300 ease-in-out hover:bg-purple-800 hover:shadow-lg"
